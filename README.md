...
### Utilities to use [pandas](https://github.com/pandas-dev/pandas)  (the data analysis/manipulation library for Python) with Qt5.
...
change to dist directory and run

pip3 install qt5pandas-0.0.1-py3-none-any.whl
...
```
If that doesn't work then please [report an issue](https://github.com/solubrew/qt5pandas/issues)
...
Forked from @draperjames's [master](https://github.com/draperjames/qtpandas).
