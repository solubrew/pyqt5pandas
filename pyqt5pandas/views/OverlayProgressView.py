from pyqt5pandas.compat import QtCore, QtGui, Qt, Signal, Slot
...
class OverlayProgressWidget(QtGui.QFrame):
	...
	def initUi(self):
		...
		self.glayout = QtWidget.QGridLayout(self)
		self.totalProgressBar = QtWidget.QProgressBar(self)
		self.totalProgressBar.setMinimumHeight(self._pbHeight)
		self.totalProgressBar.setMaximumHeight(self._pbHeight)
		self.toggleButton = QtWidget.QPushButton('Details', self)
