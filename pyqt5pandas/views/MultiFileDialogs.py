import os
from pyqt5pandas.compat import QtCore
from pyqt5pandas.views.CSVDialogs import CSVExportDialog, CSVImportDialog, _calculateEncodingKey, Slot, DataFrameModel)
class DataFrameExportDialog(CSVExportDialog):
	"""Extends the CSVExportDialog with support for exporting to .txt and .xlsx """
