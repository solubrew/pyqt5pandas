# -*- coding: utf-8 -*-
from pyqt5pandas.compat import QtCore, QtGui, Qt, QtWidgets, Slot, Signal
...
from pyqt5pandas.views.CustomDelegates import createDelegate
from pyqt5pandas.models.mime import PandasCellPayload, MimeData
...
class DragTable(QtWidgets.QTableView):
	...
	def startDrag(self, index):
		...
		mimePayload = PandasCellPayload(dfindex, columnName, value, dtype, hex(id(self.model())))
		mimeData = MimeData()
...
class DataTableWidget(QtWidgets.QTableWidget):
	'''A Customized Table widget with a TableView and a toolbar.
