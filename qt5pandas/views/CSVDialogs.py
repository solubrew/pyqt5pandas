...
from qt5pandas.compat import Qt, QtCore, QtGui, QtWidgets, Slot, Signal
# from qt5pandas.encoding import Detector
...
from qt5pandas.utils import fillNoneValues, convertTimestamps, superReadFile
...
class CSVImportDialog(QtWidgets.QDialog):
    ...
    def _openFile(self):
        ...
        ret = QtWidgets.QFileDialog.getOpenFileName(self,
                                                self.tr('open file'),
                                                filter=file_types)
