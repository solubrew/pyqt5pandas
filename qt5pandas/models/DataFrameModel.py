...
from qt5pandas.utils import superReadFile
from qt5pandas.compat import Qt, QtCore, QtGui, Slot, Signal
...
class DataFrameModel(QtCore.QAbstractTableModel):
	...
	def filePath(self):
		...
		:return: qt5pandas.models.DataFrameModel._filepath
		"""
	...
	def setFilter(self, search):
		...
		Args:
			search(qt5pandas.DataSearch): data search object to use.
		...
		if not isinstance(search, DataSearch):
			raise TypeError('The given parameter must an `qt5pandas.DataSearch` object')
	...
	def columnDtypeModel(self):
		...
		:return:
			qt5pandas.models.ColumnDtypeModel
		"""
	...
	def addDataFrameColumn(self, columnName, dtype=str, defaultValue=None):
		...
		:param columnName: str
			name of the column.
		:param dtype: qt5pandas.models.SupportedDtypes option
